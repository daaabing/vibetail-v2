  ...
  return (
    <header className={`house-header${overlay ? " house-header-overlay" : ""}`}>
      <div className="house-header-inner">
        <a className="house-wordmark" href="/" aria-label="Vibetail home">VIBETAIL</a>
...
export function SiteFooter() {
  return <footer className="house-footer"><div className="house-shell house-footer-grid">
    <div><p className="house-wordmark">VIBETAIL</p><h2>Every mood deserves<br />the perfect pour.</h2><a className="house-button house-button-light" href="/match">Match your vibe <span>→</span></a></div>
    ...
    <div><p className="house-eyebrow">Contact</p><a href="mailto:vibetail.communication@gmail.com">vibetail.communication@gmail.com</a><a href="https://www.instagram.com/vibe.tail/" target="_blank" rel="noopener noreferrer">@vibe.tail</a></div>

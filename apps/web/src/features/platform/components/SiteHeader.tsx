...
export function SiteFooter() {
  return <footer className="house-footer"><div className="house-shell house-footer-grid">
    ...
    <div><p className="house-eyebrow">Product</p><a href="/match">Match a drink</a><a href="/restaurants">Explore bars</a></div>
    <div><p className="house-eyebrow">Venues</p><a href="/for-bars">For bars</a><a href="/manage">Management</a></div>

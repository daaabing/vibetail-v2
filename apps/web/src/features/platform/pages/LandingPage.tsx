...
export function LandingPage() {
  ...
  return <div className="house-page house-landing"><SiteHeader overlay /><main>
    ...
    <section className="house-section house-paper"><div className="house-shell"><div className="house-section-head"><p className="house-eyebrow">( 04 ) Choose your door</p><h2>One platform.<br /><em>Every way into the night.</em></h2></div><div className="house-paths"><a href="/match"><span>01</span><h3>Find your drink</h3><p>Share your mood and let Vibetail choose from every live menu.</p><b>Find my match →</b></a><a href="/venues"><span>02</span><h3>Explore the bars</h3><p>Find the room first, then meet its menu.</p><b>Open the directory →</b></a><a href="/for-bars"><span>03</span><h3>Run your menu</h3><p>Publish, update availability and share your own link.</p><b>For bars →</b></a></div><p className="landing-live-note">{failed ? "The live venue count is temporarily unavailable." : venues ? `${venues.length} active ${venues.length === 1 ? "bar" : "bars"} ready to help you choose.` : "Reading tonight’s live menus…"}</p></div></section>

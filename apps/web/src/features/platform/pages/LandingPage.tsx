...
export function LandingPage() {
  ...
  return <div className="house-page house-landing"><SiteHeader overlay /><main>
    ...
    <section className="house-section house-paper-warm"><div className="house-shell specimen-layout"><div><div className="house-section-head"><p className="house-eyebrow">( 03 ) Your keepsake</p><h2>Your drink.<br /><em>Your night.</em></h2><p>Complete the order, then leave with a personalized, premium printed card made to collect and share.</p></div><a className="house-text-link" href="/venues">Find a venue →</a></div><div className="specimen-card"><img src="/brand/tile-martini.jpg" alt="A martini in Vibetail's collage style" /><div className="specimen-card-copy"><span>Personal edition · 0427</span><p>Your drink · your night</p><h3>The Second Wind</h3><blockquote>Bright / citrus / herbal</blockquote></div></div></div></section>

    <section className="house-section house-paper"><div className="house-shell"><div className="house-section-head"><p className="house-eyebrow">( 04 ) Choose your door</p><h2>One platform.<br /><em>Every way into the night.</em></h2></div><div className="house-paths"><a href="/match"><span>01</span><h3>Ask the Tasting Agent</h3><p>Share your mood and let the agent choose from every live menu.</p><b>Start tasting →</b></a><a href="/venues"><span>02</span><h3>Explore the bars</h3><p>Find the room first, then meet its menu.</p><b>Open the directory →</b></a><a href="/for-bars"><span>03</span><h3>Run your menu</h3><p>Publish, update availability and share your own link.</p><b>For bars →</b></a></div><p className="landing-live-note">{failed ? "The live venue count is temporarily unavailable." : venues ? `${venues.length} active ${venues.length === 1 ? "bar" : "bars"} ready for the Tasting Agent.` : "Reading tonight’s live menus…"}</p></div></section>

...
function buildUserPrompt(input: GenInput): string {
  ...
  const vibeBlock = vibe
    ? [
        ...
        `例如：参考条目是恋爱 / 暧昧 / 前任 / 接盘 / 表白 / 分手类，但用户当下的 vibe 是失业 / 裁员 / 被优化 / 搬家 / 独处 / 学业 / 疲惫，那你写的名字必须完全围绕用户当下的主题，绝对不能出现"恋爱 / 接盘 / 前任 / 暧昧 / 表白 / 分手 / 男友 / 女友 / 对象"这些参考条目里才有的词。反之亦然。`,
        `名字里出现的名词、场景、对象，必须来自"用户当下的 mood/vibe/preference"，不能来自"参考条目"。`,
        ``,

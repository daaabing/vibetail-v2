...
function buildUserPrompt(input: GenInput): string {
  ...
  const vibeBlock = vibe
    ? [
        ``,
        `STYLE REFERENCE — 中文手写小酒馆菜单调性 (抽象、荒诞、口语化、自嘲、谐音梗、内心OS)。`,
        `参考下面这一条的"语气和荒诞度"来生成你自己的 cocktailName / tastesLike / roast。绝对不要复用任何字符串。`,
        ...
        `1. 必须是一句完整的口语 / 内心独白 / 反问 / 吐槽 / 谐音梗，6–14 个字。绝对不要"名词+名词"的清新文艺命名（例如不要"星河晚祷""薄荷月光""琉璃夜色"这种）。`,
